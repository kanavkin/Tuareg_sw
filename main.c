...
void EXTI2_IRQHandler(void)
{
    ...
    */
    if(Tuareg.decoder->crank_position == CYLINDER_SENSOR_POSITION)
    {
        //count crank position update events
        Tuareg.sensor_interface->cylinder_sensor_counter++;

        read_cylinder_sensor();
    }
