...
*/
#define EEPROM_SENSOR_CALIBRATION_BASE 1821

/**
decoder configuration
*/
#define EEPROM_DECODER_CONFIG_BASE (EEPROM_SENSOR_CALIBRATION_BASE + SENSOR_CALIBRATION_SIZE)


/**
ignition configuration
*/
#define EEPROM_IGNITION_SETUP_BASE (EEPROM_DECODER_CONFIG_BASE + DECODER_CONFIG_SIZE)


/**
Ignition advance table (TPS based)
*/
#define EEPROM_IGNITION_ADVTPS_BASE (EEPROM_IGNITION_SETUP_BASE + IGNITION_SETUP_SIZE)

/**
Ignition advance table (MAP based)
*/
#define EEPROM_IGNITION_TABLE3D_ADVMAP_BASE (EEPROM_IGNITION_TABLE3D_ADVTPS_BASE + 288)
...
*/
#define EEPROM_STORAGE_END (EEPROM_IGNITION_ADVTPS_BASE + IGNITION_ADVTPS_SIZE)
