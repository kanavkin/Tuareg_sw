...
#define EEPROM_CALIBRATION_TPS_X (EEPROM_CALIBRATION_CLT_Y + EEPROM_CALIB_DATA_WIDTH * CALIBRATION_TABLE_DIMENSION)
#define EEPROM_CALIBRATION_TPS_Y (EEPROM_CALIBRATION_TPS_X + EEPROM_CALIB_DATA_WIDTH * CALIBRATION_TABLE_DIMENSION)

#define EEPROM_CALIBRATION_MAP_M (EEPROM_CALIBRATION_TPS_Y + EEPROM_CALIB_DATA_WIDTH * CALIBRATION_TABLE_DIMENSION)
