...
*/
#define EEPROM_FUELING_CHARGETEMP_BASE (EEPROM_FUELING_BARO_BASE + TABLE3D_RESERVED_SPACE)


/**
Fault Log - Fault_Log
*/
#define EEPROM_FAULT_LOG_BASE (EEPROM_FUELING_CHARGETEMP_BASE + TABLE2D_RESERVED_SPACE)
